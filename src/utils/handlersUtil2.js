...
function createButtonHtml(issue_id, contributor_id, svg_vote) {
  return (
    `
    ...
    setTimeout(function() {
     ...
     `;
      for (var i = startIndex; i < containerItems.length; i++) {
        ...
        const voteYesHtml = createButtonHtml(issue_id, contributor_id, svg_vote_yes);

        const voteNoHtml = createButtonHtml(issue_id, contributor_id, svg_vote_no);
